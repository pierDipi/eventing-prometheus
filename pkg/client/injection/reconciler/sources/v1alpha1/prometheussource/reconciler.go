...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.PrometheusSource, desired *v1alpha1.PrometheusSource) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.PrometheusSource, desiredFinalizers sets.Set[string]) (*v1alpha1.PrometheusSource, error) {
	// Don't modify the informers copy.
