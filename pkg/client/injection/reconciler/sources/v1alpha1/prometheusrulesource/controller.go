...
import (
	...
	versionedscheme "knative.dev/eventing-prometheus/pkg/client/clientset/versioned/scheme"
	client "knative.dev/eventing-prometheus/pkg/client/injection/client"
	prometheusrulesource "knative.dev/eventing-prometheus/pkg/client/injection/informers/sources/v1alpha1/prometheusrulesource"
...
const (
	defaultControllerAgentName = "prometheusrulesource-controller"
	defaultFinalizerName       = "prometheusrulesources.sources.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	prometheusrulesourceInformer := prometheusrulesource.Get(ctx)

	lister := prometheusrulesourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.knative.dev.PrometheusRuleSource"),
	)
