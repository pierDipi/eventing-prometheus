...
import (
	...
	externalversions "knative.dev/eventing-prometheus/pkg/client/prometheus/informers/externalversions"
	client "knative.dev/eventing-prometheus/pkg/client/prometheus/injection/client"
...
func Get(ctx context.Context, selector string) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch knative.dev/eventing-prometheus/pkg/client/prometheus/informers/externalversions.SharedInformerFactory with selector %s from context.", selector)
	}
